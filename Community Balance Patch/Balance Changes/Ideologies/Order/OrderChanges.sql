...
VALUES		('POLICY_ACADEMY_SCIENCES',	'BUILDINGCLASS_LABORATORY',	200);

INSERT INTO Policy_FreeBuilding
			(PolicyType,			BuildingClassType,				Count)
VALUES		('POLICY_SOCIALIST_REALISM',	'BUILDINGCLASS_MILITARY_ACADEMY',	200);
=======
UPDATE Policies
SET AllCityFreeBuilding = 'BUILDINGCLASS_LABORATORY'
WHERE Type = 'POLICY_ACADEMY_SCIENCES' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_POLICIES' AND Value= 1 );
